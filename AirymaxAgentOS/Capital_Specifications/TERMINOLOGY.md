...
**最新**: 2026-07-07
**状态**: 草案（文档体系完成）
**路径**: OpenAirymax/docs/AirymaxAgentOS/Capital_Specifications/TERMINOLOGY.md
...
| 层次 | 标注 | 共享程度 | 内容 |
|------|------|---------|------|
| **共享契约层** | [SC] | 完全共享代码 | `include/airymax/` 4 个头文件：`bpf_struct_ops.h`、`memory_types.h`、`security_types.h`、`cognition_types.h`。含 IPC 消息头结构、syscall 编号、capability 令牌格式、错误码、规则编号体系、五维正交24原则 |
