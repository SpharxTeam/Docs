...
- **4 核心 syscall + 20 预留 = 24 槽位**（v1.1 Capability Folding 后），与 [01-syscalls.md](01-syscalls.md) §2.2 编号分配完全一致。
