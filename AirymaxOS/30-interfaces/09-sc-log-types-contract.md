...
| 属性 | 值 |
|------|-----|
| 物理路径 | `kernel/include/airymax/log_types.h` |
...
```c
/* kernel/include/airymax/log_types.h —— printk 8 级映射 */
...
## §5 物理宿主：kernel/include/airymax/log_types.h

### 5.1 文件位置

| 属性 | 值 |
|------|-----|
| 内核侧路径 | `agentrt-linux/kernel/include/airymax/log_types.h` |
| agentrt 侧路径 | `agentrt/commons/include/airymax/log_types.h`（引用同一物理文件） |
| 实际物理文件 | 仅一份，位于 `agentrt-linux/kernel/include/airymax/log_types.h` |
...
3. 同步修改 `kernel/include/airymax/log_types.h` 物理头文件
