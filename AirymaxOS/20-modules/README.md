...
| tests-linux | [08-tests-linux.md](08-tests-linux.md) | 单元/集成/形式化/Soak/混沌/基准/eBPF 验证 |

### 4.1 Fastpath 语义分层（[01-kernel.md](01-kernel.md) §6.4）
...
**代码引用**：[file:///home/spharx/SpharxWorks/airymaxhub/docs/AirymaxOS/20-modules/01-kernel.md](file:///home/spharx/SpharxWorks/airymaxhub/docs/AirymaxOS/20-modules/01-kernel.md)（§6.4）
