...
|---|---|---|---|
| 调度语义 | MicroCoreRT 调度器 | SCHED_AGENT 策略（sched_ext） | 架构同源，无适配层 |
...
agentrt-linux 专为 Agent 工作负载优化，Agent 工作负载特性直接驱动需求：
...
| 非功能需求-可靠性 | Soak Test + 混沌工程 | Chaos Mesh + agentrt-linux 系统级测试套件 | airymaxos-tests |
| 非功能需求-兼容性 | 兼容性测试矩阵 | agentrt-linux 集成测试框架 | airymaxos-tests + system |
