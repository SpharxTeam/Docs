...
| `include/uapi/linux/airymax/security_types.h` | POSIX capability 41 ID 枚举 + LSM 钩子 250 ID 枚举 + Cupolas blob 布局 + capability 派生模型 + Vault backend 抽象 + 策略裁决结果 4 值枚举 | [SC] |
