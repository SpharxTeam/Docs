...
- **适用对象**：agentrt-linux 全部 8 子仓（airymaxos-kernel/services/security/memory/cognition/clouds/system/tests）
...
| 范围 | 规范 | 说明 |
|------|------|------|
| 开源文档（docs/AirymaxAgentOS/） | ✅ 禁止出现 开源品牌表述 | 100% 清零，防止抄袭争议 |
...
| 开源品牌清零 | `grep -riE "主流 Linux 发行版" docs/AirymaxAgentOS/` | 0 结果（排除审查报告） |
