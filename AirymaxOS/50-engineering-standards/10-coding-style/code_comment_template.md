...
**最新**: 2026-06-09
**状态**: 模板
**路径**: OpenAirymax/docs/AirymaxOS/50-engineering-standards/10-coding-style/code_comment_template.md
---
...
> **⚠️ BAN-04 合规要求**：所有 TODO/FIXME 必须引用 Issue 编号，无 Issue 引用的 TODO/FIXME 违反 [C编码规范 BAN-04](./C_coding_style_standard.md)。
...
> **⚠️ BAN-04 合规要求**：所有 FIXME 必须引用 Issue 编号，无 Issue 引用的 FIXME 违反 [C编码规范 BAN-04](./C_coding_style_standard.md)。
...
9. **Airymax 统一术语表**: [10-terminology.md](../10-terminology.md)
