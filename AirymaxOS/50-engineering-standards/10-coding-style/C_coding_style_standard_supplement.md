...
4. 内核态禁 `float`，强制 `airy_q16_t` Q16.16 定点数（OS-KER-007）
...
## 4. 规则 OS-KER-007：内核态禁 float，强制 airy_q16_t
...
| OS-KER-007 | 内核态禁 float，强制 airy_q16_t | `arch/x86/Makefile:137-138` | ERROR |
