...
| 属性 | 值 |
|------|-----|
| 仓库路径 | `agentrt-linux/airymaxos-tests` |
...
| pytest | 8.x | airymaxos-tests | 测试框架 | MIT | 已审计 |
| criterion | 0.5.x | airymaxos-tests | 基准测试 | MIT / Apache-2.0 | 已审计 |
| ktest | 0.4.x | airymaxos-tests (kernel) | 测试框架 | GPL-2.0-only | 已审计 |
...
| airymaxos-tests | 4 cores (CI) | 8 cores (CI) | 16 cores (CI) | 独立节点 | Normal (50) |
...
| airymaxos-tests | 4GB | 8GB | 32GB | 普通内存 | 测试失败 |
...
| airymaxos-tests | /var/lib/airymaxos/artifacts | 20GB | 50GB | 200GB | btrfs | 否 |
...
| airymaxos-tests | 独立 VLAN | 10Gbps | CI 端口 | 仅 CI 网络 |
...
| agentrt-linux 版本 | Kernel | Services | Security | Memory | Cognition | CloudNative | System | Tests |
|-------------------|--------|----------|----------|--------|-----------|-------------|--------|-------|
| v2.0.0 | 6.6.58-rt1 | 2.3.0 | 1.8.0 | 1.5.0 | 3.0.0-beta2 | 2.1.0 | 2.0.0 | 1.9.0 |
| v2.0.1 | 6.6.58-rt1 | 2.3.1 | 1.8.1 | 1.5.0 | 3.0.0-beta3 | 2.1.0 | 2.0.1 | 1.9.0 |
| v2.0.2 | 6.6.58-rt1 | 2.3.1 | 1.8.2 | 1.5.0 | 3.0.0-beta4 | 2.1.0 | 2.0.2 | 1.9.1 |
| v2.0.3 (当前) | 6.6.58-rt1 | 2.3.1 | 1.8.2 | 1.5.0 | 3.0.0-beta4 | 2.1.0 | 2.0.3 | 1.9.1 |
| v2.1.0 (计划) | 6.6.75-rt2 | 2.4.0 | 1.9.0 | 1.6.0 | 3.0.0-rc1 | 2.2.0 | 2.1.0 | 2.0.0 |
