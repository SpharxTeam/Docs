...
> - **子目录（5 目录 × 2 文件 = 10 文件）**：10-coding-style（6 文件）/ 20-contracts（2 文件）/ 30-runtime-interfaces（2 文件）/ 40-integration（2 文件）/ 50-project-erp（2 文件）
...
- **当前版本**: v1.3（2026-07-13，50-engineering-standards 精简合并 53→23 文档：B 组合并顶层 8→2+删除 1 / C 组合并 10-coding-style 17→6 / D 组合并 30+40+50 子目录各 4→2 / 20-contracts 4→2；更新目录树、章节定位表、五维映射、交叉引用矩阵）
