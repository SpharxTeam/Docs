...
> **SSoT 对齐**：原 80-clang-format-enforcement.md 已合并入 [01-coding-standards.md Part II](01-coding-standards.md) §8/§9。`make format-check` 规则定义详见 01-coding-standards.md Part II §8.5（OS-STD-211）。Makefile 目标定义、Git pre-commit 钩子脚本、CI 流水线集成与 checkpatch 协作流水线随代码实现补全。
