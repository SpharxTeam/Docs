...
| 架构层 | ES-SEL4-04 机制与策略分离 | sched_ext BPF 框架（机制）+ 用户态策略 | BPF 程序在用户态定义调度策略 |
| 架构层 | ES-SEL4-10 Endpoint 三态状态机 | io_uring SQ/CQ ring 等效异步消息语义 | IPC magic 0x41524531（'ARE1'）共享 |
