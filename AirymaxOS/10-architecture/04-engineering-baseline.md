...
| BPF + io\_uring 集成           | Linux 6.6          | 主线       | security 策略可插拔        |
...
| 安全性能   | fastpath C-S9 Badge 校验 | ≤10ns（fastpath 内联校验，v1.1 Capability Folding） | ≤ 基准 110%    | 微基准测试          |
...
| 调度原语 | 用户态协程             | sched\_tac + eBPF | 跨平台约束          |
