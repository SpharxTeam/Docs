...
agentrt-linux 架构设计层包含 6 个核心文档，覆盖系统架构、五维原则、微内核策略、工程基线、架构决策记录和源码目录结构。
...
| 角色 | 推荐阅读顺序 |
|------|--------------|
| 架构师 | README → 01 → 02 → 03 → 04 → 05 → 06 |
| 内核开发者 | README → 03 → 06 → 01 → 05 → 02 |
...
| E-7 文档即代码 | 本目录文档体系（架构层 6 文档，含 [SC] 头文件 Tab 8 验证） |
