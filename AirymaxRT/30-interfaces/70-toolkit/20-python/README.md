...
**最新**: 2026-06-09
**状态**: 维护中
**路径**: docs/AirymaxRT/30-interfaces/70-toolkit/20-python/README.md
---
...
# 从源码安装
git clone https://gitee.com/spharx/agentrt.git
cd agentrt/bindings/python
pip install -e .
```
...
```python
import asyncio
from agentrt import Agent, AgentConfig, TaskPriority
...
```python
from agentrt import MemoryClient, MemoryQuery
...
```python
# 异步 API（推荐）
from agentrt import Agent, MemoryClient
...
# 同步 API（阻塞调用）
from agentrt.sync import Agent, MemoryClient
...
```python
from agentrt import AgentRTError, ErrorCode
...
```python
import pytest
from agentrt import Agent, AgentConfig
from agentrt.testing import MockAgent, MockMemoryClient
...
- [Go SDK](../10-go/README.md) - Go SDK 文档
