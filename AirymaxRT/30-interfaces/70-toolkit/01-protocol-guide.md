...
| 组件 | 位置 | 说明 |
|------|------|------|
| 统一接口 | `interfaces/include/airy_protocol_interface.h` | I-L1~I-L4 接口定义 |
...
```rust
use airy_toolkit::protocol::{ProtocolClient, ProtocolConfig};
...
```bash
export AIRY_DEBUG=true
export AIRY_LOG_LEVEL=DEBUG
