...
**最新**: 2026-06-09
**状态**: 维护中
**路径**: OpenAirymax/Docs/10-architecture/05-syscall.md
---
...
typedef enum {
    ...
    // 任务相关错误
    AIRY_ETASK_NOT_FOUND = 2001,
    AIRY_ETASK_ALREADY_EXISTS = 2002,
    AIRY_ETASK_CANCELLED = 2003,

    // 记忆相关错误
    AIRY_EMEMORY_NOT_FOUND = 3001,
    AIRY_EMEMORY_WRITE_FAILED = 3002,
    AIRY_EMEMORY_SEARCH_FAILED = 3003,

    // 会话相关错误
    AIRY_ESESSION_NOT_FOUND = 4001,
    AIRY_ESESSION_EXPIRED = 4002,

    // 系统调用错误
    AIRY_ESYSCALL_UNKNOWN = 5001,
    AIRY_ESYSCALL_FAILED = 5002
} airy_err_t;
```
