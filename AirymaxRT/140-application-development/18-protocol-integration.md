...
// claude_desktop_config.json
{
  "mcpServers": {
    "agentrt": {
      "command": "npx",
      "args": ["-y", "@agentrt/mcp-adapter"],
      "env": {
        "AIRY_GATEWAY_URL": "http://localhost:8080",
        "AIRY_API_KEY": "your-api-key"
      }
    }
  }
}
...
curl -X POST http://localhost:8080/v1/chat/completions \
  ...
  -H "Authorization: Bearer $AIRY_API_KEY" \
  -d '{
    "model": "agentrt-default",
    "messages": [
...
```json
{
  "object": "list",
  "data": [
    {"id": "agentrt-default", "object": "model", "owned_by": "agentrt"},
    {"id": "agentrt-code-gen", "object": "model", "owned_by": "agentrt"},
    {"id": "agentrt-reasoning", "object": "model", "owned_by": "agentrt"}
  ]
}
```
